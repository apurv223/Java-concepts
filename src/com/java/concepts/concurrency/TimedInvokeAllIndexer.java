...
public class TimedInvokeAllIndexer {
	...
	private static final long TIME_FRAME = 1000000000L; // 1 seconds
	...
	private static class Downloader<T extends Weblink> implements Callable<T> {
		...
		public T call() {
			try {
				...
				weblink.setHtmlPage(sb.toString());
				System.out.println("Downloaded: " + weblink.getId());
